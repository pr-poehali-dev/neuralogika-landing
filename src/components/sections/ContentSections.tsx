...
const cases = [
  ...
  {
    industry: "Селлер на Wildberries",
    result: "+42% к продажам",
    desc: "Оптимизировали карточки товаров с помощью ИИ и настроили автоответы на отзывы для магазина с 300+ позициями. Карточки поднялись в выдаче, рейтинг вырос.",
    duration: "5 недель",
  },
  {
    industry: "Продавец на Ozon",
    result: "−15 часов в неделю",
    desc: "Внедрили мониторинг цен конкурентов и единую аналитику продаж. Освободили время от рутины на ручное отслеживание и сведение отчётов.",
    duration: "1 месяц",
  },
  {
    industry: "Финансовая компания",
    result: "0 утечек данных",
    desc: "Внедрили компактную языковую модель (SLM) на инфраструктуре клиента для обработки обращений. Конфиденциальные данные не покидают периметр компании.",
    duration: "2 месяца",
  },
];
